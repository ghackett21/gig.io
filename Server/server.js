...
function GetUser_Helper(userId) {
 ...
 function GetUserPosts(userId, callback) {
 	var select = "SELECT Posting.Pid, Posting.P_Location, Posting.CreationTime, Posting.P_Description, Users.Uid, Users.Username, Users.U_Description, Users.U_Location, Users.PhoneNumber, Users.DateJoined, Users.EmailAddress, Users.AVG_PostRate, Users.AVG_BidRate FROM Posting Inner Join Users On Posting.Uid=Users.Uid (SELECT * FROM Users WHERE Uid LIKE " + userId + ")";
