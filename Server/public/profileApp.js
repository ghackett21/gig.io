    	...
    	$http.post('/GetUser').then(function(response) {
            ...
            $http.post('/GetUserRatings', userInfo).then(function(response) {
                  ...
                  for (var i = 0 ; i < arr.length; i++) {
                      ...
                      td[0].innerHTML = "<b><a class=\'bidprof-link ng-binding\' style=\"font-size:18px\" onclick=\"angular.element(this).scope().otherUserProfile(" + user.Uid + ")\">" + currRating.Username + "</a></b>";
